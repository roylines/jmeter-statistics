...
lab.experiment("jtl", () => {
  lab.test("should", (done) => {
    ...
    jtl(reader, writer, () => {
      ...
      lines[0].should.equal('label,requestCount,meanResponseTimeMillis,meanRequestsPerSecond,errorPercentage,apdex,satisfied,tolerating,frustrated');
      ...
      line1[4].should.equal('0.25');
      line1[5].should.equal('0.63');
      line1[6].should.equal('1');
      line1[7].should.equal('3');
      line1[8].should.equal('0');
      ...
      line2[4].should.equal('0');
      line2[5].should.equal('0.38');
      line2[6].should.equal('0');
      line2[7].should.equal('3');
      line2[8].should.equal('1');
      return done();
    });
  });
});
